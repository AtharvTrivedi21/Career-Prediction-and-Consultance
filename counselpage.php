...
<header class="w3-container w3-blue w3-center" style="padding:12px 16px 20px 16px">
  ...
  <h2 class="w3-margin w3-jumbo">counsellor page login</h2>
 <!-- <p class="w3-xlarge">Template by w3.css</p>-->
  <button class="w3-button w3-black w3-padding-large w3-large w3-margin-top w3-hover-amber" onclick="document.getElementById('id04').style.display='block'" style="width:auto;">login</button>
...
<form class="modal-content animate" autocomplete="off"  method="post" action="" background-color:aquamarine">
  ...
  <div class="imgcontainer">
    ...
    <label><center><h1>counsellor</h1></center></label>
    <img src="img_avatar.png" alt="Avatar" class="avatar">
  </div>

  <div class="container">
    <label for="cname"><b>counseller name</b></label>
    <input type="text" placeholder="Enter counsellor name" name="cname" required>

    <label for="apsw"><b>Password</b></label>
    <input type="password" placeholder="Enter Password" name="cpsw" required>
      
    <input type="submit" name="clog" id="clog" value="submit"></input>
...
window.onclick = function(event) {
  ...
  <div class="w3-container w3-black w3-center w3-opacity w3-padding-24">
    <h1 class="w3-margin w3-xlarge">Quote of the day: "Hold the vision, trust the process."</h1>
</div>
