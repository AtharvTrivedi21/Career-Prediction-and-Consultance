...
<header class="w3-container w3-blue w3-center" style="padding:100px 16px">
 ...
 <!-- <p class="w3-xlarge">Template by w3.css</p>-->
  <a href = "Aptitudetestz.php" target = "_self"><button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" style="width:auto;">Click Here to give Test</button></a>
