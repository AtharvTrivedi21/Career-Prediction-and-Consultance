...
$show1=mysqli_query($conn, "SELECT * FROM signup_table");
echo "<h3>Registered Users</h3>";
echo"<table border = '1'>";
echo "<tr><td>"."<b>Username</b>" . "</td><td>" . "<b>Date of Birth</b>" . "</td><td>" . "<b>Email ID</b>" . "</td><td>" . "<b>Ph no</b>" . "</td><td>" . "<b>Password</b>";
echo "</td></tr>";
while($row = mysqli_fetch_array($show1))
{
    echo "<tr>";
    echo "<td>".$row['uname'] . "</td><td>" . $row['dob'] . "</td><td>" . $row['email'] . "</td><td>" . $row['mobno'] . "</td><td>" . $row['psw'];
    echo "</td></tr>";
}
echo "</table>";
echo "<br>";
